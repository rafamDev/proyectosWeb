...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
             <form class="form-signin" action="/practicaJSP/ServletControlador?accion=login" method="post">       
        ...
        <div class="col-md-12 text-center bg-info">
            <jsp:include page="WEB-INF/paginas/jspFiles/agregarCliente.jsp"></jsp:include>       
        </div>
        <jsp:include page="WEB-INF/paginas/jspFiles/footer.jsp"></jsp:include>
